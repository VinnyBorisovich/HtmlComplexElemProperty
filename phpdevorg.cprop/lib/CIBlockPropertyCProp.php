...
class CIBlockPropertyCProp
{
    ...
    private static function showHtml($code, $title, $arValue, $strHTMLControlName)
    {
        ...
        ob_start();
        CFileManPhpDevOgr::AddHTMLEditorFrame(
...
class CFileManPhpDevOgr extends CFileMan
{
    ...
    )
    {
        ...
        parent::ShowHTMLEditControl($strTextFieldName, $strTextValue, $arParams);
    }
}